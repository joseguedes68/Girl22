...
'este código foi feito pela sirene

Public Class frmComunicarGT_AT_Exemplo




    Dim strEncryptPasswordAT As String, strEncryptCreatedAT As String, strEncryptNonceAT As String
    Dim MyPassCER As String = "xxxxxxxxxx_2000"
    Dim CaminhoFileCER As String = "C:\Inova\ChavePublicaAT.cer"
    Dim NIF_ID As String = "xxxxxxxxxx/1"
    Dim CaminhoPFX As String = "C:\Inova\TesteWebServices.pfx"
    Dim MyPassPFX As String = "TESTEwebservice"
    ...
    Private Function GenerateSoapFile(ByVal pUserAT As String) As String
        Try
            ...
            strSoap = strSoap & "<TaxRegistrationNumber>999999990</TaxRegistrationNumber>"
            strSoap = strSoap & "<CompanyName>Teste</CompanyName>"
            strSoap = strSoap & "<CompanyAddress>"
            strSoap = strSoap & "<Addressdetail>Rua de testes</Addressdetail>"
            strSoap = strSoap & "<City>Aveiro</City>"
            strSoap = strSoap & "<PostalCode>3830-134</PostalCode>"
            strSoap = strSoap & "<Country>PT</Country>"
            strSoap = strSoap & "</CompanyAddress>"
            strSoap = strSoap & "<DocumentNumber>GT 13/10</DocumentNumber>"
            ...
            strSoap = strSoap & "<CustomerTaxID>NIF</CustomerTaxID>"
            ...
            strSoap = strSoap & "<City>Aveiro</City>"
            strSoap = strSoap & "<PostalCode>3800-000</PostalCode>"
            strSoap = strSoap & "<Country>PT</Country>"
            strSoap = strSoap & "</CustomerAddress>"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        txtResultado.Text = GetATGTCode(soap, "https://servicos.portaldasfinancas.gov.pt:701/sgdtws/documentosTransporte", "https://servicos.portaldasfinancas.gov.pt:701/sgdtws/documentosTransporte/", CaminhoPFX, MyPassPFX)
