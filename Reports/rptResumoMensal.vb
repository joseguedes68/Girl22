...
Public Class rptResumoMensal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GirlRootName.rptResumoMensal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumoMensal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumoMensal = New rptResumoMensal()
        rpt.Site = Me.Site
        Return rpt
    End Function
