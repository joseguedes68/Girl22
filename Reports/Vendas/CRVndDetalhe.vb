...
Public Class CRVndDetalhe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GirlRootName.CRVndDetalhe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVndDetalhe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVndDetalhe = New CRVndDetalhe()
        rpt.Site = Me.Site
        Return rpt
    End Function
