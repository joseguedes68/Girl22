...
Public Class CrVndAcessorios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GirlRootName.CrVndAcessorios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrVndAcessorios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrVndAcessorios = New CrVndAcessorios()
        rpt.Site = Me.Site
        Return rpt
    End Function
