...
Public Class rptResumoMensalEx1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GirlRootName.rptResumoMensalEx1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumoMensalEx1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumoMensalEx1 = New rptResumoMensalEx1()
        rpt.Site = Me.Site
        Return rpt
    End Function
