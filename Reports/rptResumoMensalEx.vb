...
Public Class rptResumoMensalEx
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GirlRootName.rptResumoMensalEx.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumoMensalEx
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumoMensalEx = New rptResumoMensalEx()
        rpt.Site = Me.Site
        Return rpt
    End Function
